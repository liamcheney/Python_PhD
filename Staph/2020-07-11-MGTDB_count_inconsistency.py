...
def parseargs():
    ...
    ##Database connecting
    parser.add_argument("-d", "--database_name", default='saureus_3',
                        help="sql database to search (eg. saureus_4)")
    parser.add_argument("-a", "--app_name", default='Staphylococcus',
                        help="MGT database App Name(eg. Staphylococcus)")
    ...
    parser.add_argument("-n", "--scheme_number", default=9,
                        help="Number of scheme levels in MGT database.")
...
def main():
    ...
    for lev in range(3,max_level):
        ...
        for compare in matching:
            if compare == lev-1:
                ...
                print(lev, round(missmatch_perc,1))
    ...
    plt.savefig("/Users/liamcheneyy/Desktop/testplot_hier_incocnsistency.pdf")
